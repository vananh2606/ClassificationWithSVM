...
# Load dữ liệu
X, y = load_data("TrainModel/SVC/TestSVC/dataset_2D.csv")
...
with open("TrainModel/SVC/TestSVC/svm_model.pkl", "wb") as f:
    pickle.dump(svm_model, f)

# Load model with pickle
with open("TrainModel/SVC/TestSVC/svm_model.pkl", "rb") as f:
